...
public class TestQuickSort
{
	...
	public void testPrimitiveType()
	{
		...
		QuickSort.quickSort(array_long);
		...
		QuickSort.quickSort(array_float);
		...
		QuickSort.quickSort(array_double);
		...
		QuickSort.quickSort(array_char);
		...
		QuickSort.quickSort(array_short);
	...
	public void testGeneric()
	{
		...
		QuickSort.quickSort(list, new Comparator<Integer>()
		{
			@Override
			public int compare(Integer o1, Integer o2)
			{
		...
		QuickSort.quickSort(array, new Comparator<Integer>()
		{
			@Override
			public int compare(Integer o1, Integer o2)
			{
