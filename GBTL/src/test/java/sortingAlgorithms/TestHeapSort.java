...
public class TestHeapSort
{
	...
	public void testPrimitiveType()
	{
		...
		HeapSort.heapSort(array_double);
	...
	public void testGeneric()
	{
		...
		HeapSort.heapSort(list, new Comparator<Integer>()
		{
			@Override
			public int compare(Integer o1, Integer o2)
			{
		...
		HeapSort.heapSort(array, new Comparator<Integer>()
		{
			@Override
			public int compare(Integer o1, Integer o2)
			{
