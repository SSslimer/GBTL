...
public class TestBubbleSort
{
	...
	public void testPrimitiveType()
	{
		...
		BubbleSort.bubbleSort(array_int);
		...
		BubbleSort.bubbleSort(array_long);
		...
		BubbleSort.bubbleSort(array_float);
		...
		BubbleSort.bubbleSort(array_double);
	...
	public void testGeneric()
	{
		...
		BubbleSort.bubbleSort(list, new Comparator<Integer>()
		{
			@Override
			public int compare(Integer o1, Integer o2)
			{
		...
		BubbleSort.bubbleSort(array, new Comparator<Integer>()
		{
			@Override
			public int compare(Integer o1, Integer o2)
			{
