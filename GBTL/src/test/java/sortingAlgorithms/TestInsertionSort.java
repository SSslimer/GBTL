...
public class TestInsertionSort
{
	...
	public void testPrimitiveType()
	{
		...
		InsertionSort.insertionSort(array_int);
		...
		InsertionSort.insertionSort(array_long);
		...
		InsertionSort.insertionSort(array_float);
		...
		InsertionSort.insertionSort(array_double);
		...
		InsertionSort.insertionSort(array_char);
		...
		InsertionSort.insertionSort(array_short);
	...
	public void testGeneric()
	{
		...
		InsertionSort.insertionSort(list, new Comparator<Integer>()
		{
			@Override
			public int compare(Integer o1, Integer o2)
			{
		...
		InsertionSort.insertionSort(array, new Comparator<Integer>()
		{
			@Override
			public int compare(Integer o1, Integer o2)
			{
