...
public class TestMergeSort
{
	...
	public void testPrimitiveType()
	{
		...
		MergeSort.mergeSort(array_long);
		...
		MergeSort.mergeSort(array_float);
		...
		MergeSort.mergeSort(array_double);
		...
		MergeSort.mergeSort(array_char);
		...
		MergeSort.mergeSort(array_short);
	...
	public void testGeneric()
	{
		...
		MergeSort.mergeSort(list, new Comparator<Integer>()
		{
			@Override
			public int compare(Integer o1, Integer o2)
			{
		...
		MergeSort.mergeSort(array, new Comparator<Integer>()
		{
			@Override
			public int compare(Integer o1, Integer o2)
			{
